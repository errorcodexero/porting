...
public:
    ...
    static constexpr uint32_t kBatteryModuleNumber = 1;
    static constexpr uint32_t kBatteryChannel = 8;
    static constexpr uint32_t kJoystickPorts = 4;
    static constexpr uint32_t kJoystickAxes = 6;
